package com.example.cashcardkotlin.cashcard.service
...
class CashCardService(
    val cashCardRepository: CashCardRepository,
    val userRepository: UserRepository,
    val userDetailsService: UserDetailsService
) {

    fun findCashCardById(requestedId: Long, principal: Principal): ResponseEntity<CashCardDto> {
    ...
    fun findAllCashCards(pageable: Pageable, principal: Principal): ResponseEntity<List<CashCardDto>> {
    ...
    fun createCashCard(cashCardRequest: CashCardRequest, uriComponentsBuilder: UriComponentsBuilder,
        ...
        val newCashCard = cashCardRequest.toCashCard(
    ...
    fun deleteCashCard(id: Long, principal: Principal): ResponseEntity<Void> {
